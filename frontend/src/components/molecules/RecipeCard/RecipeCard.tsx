/**
 * RecipeCard molecule component
 * 
 * A card component for displaying recipe information with interactive elements.
 */
...
export const RecipeCard: React.FC<RecipeCardProps & { style?: React.CSSProperties }> = ({
  recipe,
  onClick,
  className = '',
  style,
